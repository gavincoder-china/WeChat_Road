...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.getLocation({
      ...
      success: function (res) {
        ...
        wx.request({
          url: 'https://t.weather.sojson.com/api/weather/city/101030100&location=' + longitude + ',' + latitude,
          data: {
          },
          header: {
  ...
  hiddenFloatView: function (e) {
    ...
    var that = this;
    wx.request({
      url: 'https://t.weather.sojson.com/api/weather/city/101030100&location=' + countyCity,
      data: {
      },
      header: {
        'content-type': 'application/json' // 默认值
  ...
  getlive: function (lon, lat) {
    wx.request({
      url: 'https://t.weather.sojson.com/api/weather/city/101030100&location=' + lon + ',' + lat,
      data: {
      },
      header: {
        'content-type': 'application/json' // 默认值
